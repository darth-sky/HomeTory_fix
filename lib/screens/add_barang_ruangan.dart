...
class AddBarangRuangan extends StatefulWidget {
  ...
  @override
  State<AddBarangRuangan> createState() => _AddBarangRuanganState();
}
...
class _AddBarangRuanganState extends State<AddBarangRuangan> {
  ...
  final TextEditingController _descItemController = TextEditingController();
  String _title = "";
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (barangRuanganName.isNotEmpty &&
                          ...
                          _postDataWithImage(context, widget.idInsideRuangan, accessToken!);
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
