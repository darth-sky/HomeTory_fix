...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  MultiBlocProvider(
      providers: [
        BlocProvider<RuanganCubit>(create: (context) => RuanganCubit(),),
        BlocProvider<ContainersCubit>(create: (context) => ContainersCubit(),),
        BlocProvider<BarangDlmRuanganCubit>(create: (context) => BarangDlmRuanganCubit(),),
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/home-screen': (context) => const AuthWrapper(child: Myhomepage(title: 'HomeTory',)),
        },
      ),
    );
  }
